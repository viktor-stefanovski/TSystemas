			            	...
			            	<div class="capcelera_basica_cont">
									...
									<div class="menu_flotant menu_enviar_amic">
										...
										<ol class="breadcrumb filariana hidden-xs">
															...
															<li>Catalans i catalanes residents a l&#039;exterior: Identificació</li>
...
<script>//Para cambiar el enlace de compartir por Whatsapp en p�ginas de detalle
	 $(document).ready(function() {
		...
		<h1 class="title_left">Benvingut/da al portal d'identificació</h1>
...
<!-- Contenido -->
	...
	<div class="bgGrey2">
		...
		<p style="font-size: 12px; text-align:left;">Per poder procedir, omlpe el següent formulari.</br>
		<small><em>Tindreu 4 intents per validar les vostres dades. En cas d'error tots els camps sortiran ressaltats en vermell.</br>
		En el cas que no recordeu les vostres dades amb les quals et vas inscriure al registre, pots demanar un certificat d'inscripció a registrecatalans.exteriors@gencat.cat</em></small>
		</p>
	</div>
