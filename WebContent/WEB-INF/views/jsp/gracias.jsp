	 ...
	 $(document).ready(function() {
		...
		<!-- Contenido -->
			...
			<div class="col-md-12 gracias">
				<h1 style="font-size:30pt; ">Li agraïm el temps que ha dedicat a emplenar aquesta enquesta. La seva opinió és molt important i ens ajuda a conèixer les necessitats dels catalans i catalanes residents a l’exterior per tal que les actuacions de la Generalitat siguin més efectives.</h1>
			</div>
			</div>
				
				<form name="myRedirectForm" id="myRedirectForm" action="https://es.surveymonkey.com/r/YC87ZHT">
					<noscript>
