...
<!-- Contenido -->
	...
	<form action="alta2">
		<div class="altacampa">
		<h2>Donar d'alta una campanya</h2>
		<!-- Id Campanya -->
		<div class="col-sm-6 alta">
			<label>ID: </label><br>
			<input type='text' name='id_campa' class="alta_id"/>
		</div>
		<!-- Nom Campanya -->
		<div class="col-sm-6 alta">
			<label>Nom: </label><br>
		...
		<div class="col-sm-6 alta">
			<label>Tipus de campanya:</label><br>
		            <input type="radio" name="tipo_attach" value="digital"> Digital
		            <input type="radio" name="tipo_attach" value="pdf" > PDF
		</div>
		...
		<!-- Comodin -->
		<div class="col-sm-6 alta">
			<label>Comodin:</label><br>
		            <input type="radio" name="comodincontrol" value="com" onclick="mostrar(this.value)"> Si
		            <input type="radio" name="comodincontrol" value="no" onclick="mostrar(this.value)"> No
		</div>
		
		<div class="col-sm-6 alta"  id="com" style="display:none; float:right;">
			<br><label>Valor comodin: </label>
			<form method="get" action="">
			  <input type="text" name="comodin">
			</form>
		</div>
		
		<div class="col-sm-12 alta">
			<label>Comentari de la campanya: </label><br>
			<textarea name="commentario" rows="4" cols="100" placeholder="Escriu el teu comentari sobre la campanya...">
			</textarea>			
		</div>
