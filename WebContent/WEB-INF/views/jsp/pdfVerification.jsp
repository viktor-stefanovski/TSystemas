...
<!---->
<title>Enquestes. Catalans i catalanes residents a l'exterior. Departament d'Afers i Relacions Institucionals i Exteriors i Transparència</title>
...
<!-- Contenido -->
	<div  id="center_1R" class="center_div" >
			<form action="pdf" commandName="userForm" accept-charset="UTF-8"> <!-- action="process.jsp" -->
	
	<div class="bgGrey clearfix container">
	
	<div class="bgGrey2">
	
		<p> Per validar-se s'ha d'omplir el formulari correctament amb els camps obligatoris especificats amb un * i  en cas d'error es marcarà en color vermell. 
		<small><em>Tindreu 4 intents per validar les vostres dades. En cas d'error tots els camps sortiran ressaltats en vermell.</em></small>
		<small><em>En el cas que no recordeu les vostres dades amb les auqls et vas inscriure al registre, pots demanar un certificat d'inscripció a registrecatalans.exteriors@gencat.cat</em></small>
		</p>
	</div>
		...
		<div class="col-xs-12 reset-only-xs clearfix">
                	<div class="col-xs-12 col-sm-12 clearfix-xs">
		                ...
		                <div id="webForm.lastName2">
		             		...
		             		<div  class="col-xs-12 col-md-4 a">
			                  	...
			                  	<div id="error.form">
			                  		<input type="text" name="firstName" maxlength="100" value="<%-- <%=valueFirstName%> --%>" id="nom" class="form-control" />
								</div>
							</div>
			              	...
			              	<div  class="col-xs-12 col-md-4 a">
			            		<label for="primercognom">
									...
									<div id="error.form">
			             				<input type="text" name="lastName1" maxlength="200" value="<%-- <%=valueLastName%> --%>" id="primercognom" class="form-control" />
			             			</div>			             		
							...
							<div  class="col-xs-12 col-md-4 ">                  	
								...
								<div id="error.div">
			               			<input type="text" name="lastName2" maxlength="200" value="" id="segoncognom" class="form-control" />
			            		</div>
			            	</div>
					...
					<div id="doc.validate.error.no.doc.value">
				        	...
				        	<div id="conqxsmanager.error.only.cif"> 
							        ...
							        <div id="error.form" class="col-xs-12 col-md-6 selectdiv">
							        	<label for="descIdentSelect">
								    									    	
						       			</label>
							            <select name="authDocType1" id="descIdentSelect" class="form-control custom_select hasCustomSelect">
							            	<option value="0" ${role == selectedRole ? 'selected' : ''}>[Seleccioneu]</option>
											<option value="11">DNI</option>
											<option value="22">Passaport</option>
										</select>
										<!-- <select name="authDocType2" onchange="checkDocTypeSelectedDocEmpresa();" id="descIdentFullSelect" class="form-control custom_select hasCustomSelect" style="-webkit-appearance: menulist-button; width: 688px; position: absolute; opacity: 0; height: 35px; font-size: 14px;"><option value="0">[Selecciona]</option>
											<option value="2">NIF d'empresa</option>
											<option value="1">DNI</option>
											<option value="4">NIE</option>
											<option value="3">Passaport</option>
											<option value="8">Document d'identitat estranger</option>
											<option value="9">Document d'empresa estrangera</option>
										</select> -->
							        </div>
						        ...
						        <div id="error.div" class="col-xs-12 col-md-6" >
						            ...
						            <input type="text" name="authDoc1Value" maxlength="50" value="<%-- <%=valueDocNumber%> --%>" id="docIdentValue" class="form-control" />
								</div>
					            </div>
				            </div>
				            </div>
				      	...
				      	<div class="col-xs-12 col-md-6">
							<div class="form-group">
								<label class="form-label required">Data de naixement</label> <input
									...
									name="birthDate"
									class="col-sm-12 form-control" maxlength="10">
							</div>
						</div>
				    ...
				    <div id="munic.form" class="col-xs-12 col-md-6 municip">
							            ...
							            <select name="municipo" id="municSelect" class="form-control custom_select">
										...
										<!-- <div class="g-recaptcha" data-sitekey="6LfNXSYUAAAAACYzO6xNSZnEKumosJLWOrCmY__r"></div>
										 -->
...
<%-- 										<%
				    ...
				    <div class="form col-xs-12 col-md-12 padding-xs bgWhite">
                        ...
                        <input type="submit" name="acceptem" value="Envieu" onclick="" id="acceptemSubmit" class="btn bgRed white margin_top_xs" title="<%=hash%>" />  
                    </div>
