...
<!-- Contenido -->
	...
	<div class = "main bgGrey" ">
			<h1 style="font-size:30pt; padding-top: 15px; ">Benvingut/da <!-- ${firstName} --> <br> Fes clic al botó per començar l'enquesta</h1>
<%-- 			<input type="button"  name="acceptem" value="Encuesta" onclick="location.href='https://www.research.net/r/RegistresCatalans'; <!-- updateEncuestado() -->" id="enc" class="btn bgRed white margin_top_xs button" title="Encuesta" /> --%>
		<div class="enquesta">
		<form action="redSurv" class="verificado">
			<input type="hidden" name="hash" value="<%=hash%>">
			<input type="submit"  name="button1" value="Fes l'enquesta" onclick="" class="btn bgRed white margin_top_xs button hoverA" title="Fes l'enquesta" />
