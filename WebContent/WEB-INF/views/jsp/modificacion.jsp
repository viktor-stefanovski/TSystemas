...
<script>//Para cambiar el enlace de compartir por Whatsapp en p�ginas de detalle
	 $(document).ready(function() {
		...
		<!-- Contenido -->
			...
			<div class="altacampa">
				<h2>Modificar una Campanya</h2>
				<!-- Id Campanya -->
				<div class="col-sm-6 alta">
					<label>ID: </label><br>
					<select class="modi">
						<option value="20170000A">20170000A</option>
						<option value="20170000B">20170000B</option>
						<option value="20170001A">20170001A</option>
					</select>
				</div>
				<!-- Nom Campanya -->
				<div class="col-sm-6 alta">
					<label>Nom: </label><br>
					<input type='text' name='nom_campa' class="alta_id"/>
				</div>
				
				<!-- Data Inici Campanya -->
				<div class="col-sm-6 alta">
					<label>Data d'inici: </label><br>
					<input type='date' name='data_ini'>
				</div>
				<!-- Data Final Campanya -->
				<div class="col-sm-6 alta">
				<label>Data final: </label><br>
					<input type='date' name='data_fin'>
				</div>
				<!-- Hora Campanya -->
				<div class="col-sm-6 alta">
					<label>Hora d'inici: </label><br>
					<input type='time' name='hora_campa' />
				</div>
				<div class="col-sm-6 alta">
				...
				<!-- Tipo de Campanya -->
				<!--  <div class="col-sm-12 alta">
					<label>Tipus de campanya:</label><br>
				            <input type="radio" name="tipo_attach" value="capa1" onclick="mostrar(this.value)"> Digital <br>
				            <input type="radio" name="tipo_attach" value="capa2" onclick="mostrar(this.value)" > PDF
				</div> -->
				
				
				<!-- Pujar fitxer DDBB Campanya -->
				<div class="col-sm-12 alta"  id="capa1" style="display:none">
					<br><label>Pujar fitxer llista de contacte: </label>
					<form method="get" action="">
					  <input type="file" name="csv" accept="csv/*">
		   				<p><strong>Nota:</strong> Al fitxer ha de ser CSV o SQL.</p>
					</form>		
				<!-- URL Enqueste -->
					<br><label>URL d'Enquesta SurveyMonkey: </label>
					<input type='text' name='url_campa' />
				</div>
				
				<!-- PDF Enqueste -->
				<div class="col-sm-12 alta" id="capa2" style="display:none">
					<label>Pujar Fitxer PDF: </label><br>
					<form method="get" action="">
				...
				<!-- Comentaris Campanya -->
				<div class="col-sm-12 alta">
					<label>Comentari de la campanya: </label><br>
					<textarea rows="2" cols="30" placeholder="Escriu el teu comentari sobre la campanya...">
					</textarea>			
				</div>
				...
				<div class="col-sm-12 alta">
					<form action="gestion">
						<input type= "submit" value="Guardeu" class="btn bgRed white margin_top_xs">
						<input type= "submit" value="Sortir" class="btn bgRed white margin_top_xs">
					</form>
				</div>
