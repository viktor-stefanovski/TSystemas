...
<!-- Contenido -->
	...
	<form form method="POST" action="upload" enctype="multipart/form-data"">
		...
		<div class="altacampa">
			<h2>Donar d'Alta una Campanya - Càrrega de fitxers</h2>
		<!-- Id Campanya -->
	
	<%
		String idCampagna = (String)request.getAttribute("idCampagna");
	
		if (idCampagna.contains("A")) {
	%>	
			<!-- Pujar fitxer DDBB Campanya -->
		<div class="col-sm-6 alta"  id="capa1" style="display:block">
		...
		<div class="col-sm-6 alta"  id="capa1" style="display:block">
			...
			<input type='text' name='url_campa' /><br>
		</div>
	<% 
		} else if(idCampagna.contains("B")) {
	%>	
		<!-- PDF Enqueste -->
		<div class="col-sm-12 alta" id="capa2" style="display:block">
			<br><label>Pujar Fitxer PDF: </label><br>
