...
<script>//Para cambiar el enlace de compartir por Whatsapp en p�ginas de detalle
	 $(document).ready(function() {
		...
		<!-- Contenido -->
			...
			<div class="adminlist">
		<h2>Informe d'una campanya ID</h2>			
		</div>
		...
		<div class="col-sm-12 report">
				...
				<input type= "submit" onclick="validate();" value="Descarregue informe" class="btn bgRed white margin_top_xs">
			...
			<div class="col-sm-12 report">
			<form action="gestion">
				<input type= "submit" value="Sortiu" class="btn bgRed white margin_top_xs">
			</form>
		</div>
