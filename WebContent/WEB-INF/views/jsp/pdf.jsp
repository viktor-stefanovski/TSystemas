...
<link href="http://preproduccio.registredecatalans.exteriors.gencat.cat/css/bootstrap-overrides.css" rel="stylesheet" type="text/css"/>	
...
<!-- Contenido -->
	...
	<div class = "main bgGrey" ">
			<h1 style="font-size:30pt; padding-top: 15px; ">Benvingut/da <!-- ${firstName} --> <br> Feu clic al botó per a descarregar l'enquesta</h1>
<%-- 			<input type="button"  name="acceptem" value="Encuesta" onclick="location.href='https://www.research.net/r/RegistresCatalans'; <!-- updateEncuestado() -->" id="enc" class="btn bgRed white margin_top_xs button" title="Encuesta" /> --%>
		<div class="enquesta">
		<form method="get" class="verificado"> <!-- action="http://aticserver.com/aticser/Document.pdf" --> 
			<input type="hidden" name="hash" value="<%=hash%>">
			<!-- <input type="submit" onclick="location.href='http://aticserver.com/aticser/prueba.pdf'" name="button1" value="Fer la PDF enquesta" onclick="" id="enc" class="btn bgRed white margin_top_xs button" title="Fer la PDF enquesta" /> -->
			<a class="btn bgRed white margin_top_xs button hoverA" href="http://aticserver.com/aticser/Document.pdf" download>Enquesta en pdf</a>
		
		<div class="col-md-12 bgGrey">
		<!-- <p>Rebrà també aquest document a l’adreça de correu electrònic que ha informat.
		Li agraïm el temps dedicat a emplenar aquesta enquesta. La seva opinió és molt important i ens ajuda a conèixer les necessitats dels catalans i catalanes residents a l’exterior per tal que les actuacions de la Generalitat siguin més efectives. -->
		</p>
		</div>
		</form>	
	</div>	
